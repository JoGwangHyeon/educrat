                ...
                <div className="header__logo ">
                  <Link href="/">
                    <Image
                      width={140}
                      height={50}
                      src="/assets/img/new/logo_header_02.png"
                      alt="미래에셋자산운용"
                    />
                  </Link>
                </div>
              ...
              <div className="header-right d-flex items-center">
                <div className="header-right__icons text-white d-flex items-center">
                  ...
                  <CartToggle
                    ...
                    allClasses={"d-flex items-center text-black"}
                  />
                  {/* cart toggle end */}
                ...
                <div className="header-right__buttons d-flex items-center ml-30 md:d-none">
                  <Link href="/login" className="button -underline text-black">
                    Log in
                  </Link>
                  <Link
                    href="/signup"
                    className="button -sm -black text-white ml-30"
                  >
                    Sign up
                  </Link>
                </div>
